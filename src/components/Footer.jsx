    ...
    <div>
      <footer className="footer sm:footer-horizontal whitebg text-base-content p-10">
        ...
        <aside className="flex flex-col ml-0 md:ml-12">
          ...
          <p className="mt-1 text-sm text-secondary">
            ...
            where users can borrow and return books without visiting the
            library. <br />
        ...
        <nav>
          ...
          <Link to="/dashboard/wishlist" className="link link-hover">
            Wishlist
          </Link>
        ...
        <nav>
          ...
          <div className="flex flex-col">
            <div className="mt-0 text-sm">
              <p>Email: anisurrahman57136@gmail.com</p>
              <p>Phone: +8801313131313</p>
            </div>
            <div className="flex space-x-4 text-xl mt-4">
              {/* Social icons with hover brand colors */}
              <a
                href="https://www.facebook.com/anisurrahmanARS2"
                target="_blank"
              ...
              <a
                href="https://x.com/@AnisurR06680216"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.instagram.com/anisur6650/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.linkedin.com/in/anisurrahman/"
                target="_blank"
                rel="noopener noreferrer"
      ...
      <div className="w-full mt-0 whitebg">
        ...
        <p className="text-center text-sm p-2 text-secondary">
          ...
          <Link
            to="https://anisurrahman.netlify.app/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <span className="font-bold text-green-500 hover:text-[#1DA1F2] hover:cursor-pointer">
              {" "}
              MD Anisur Rahman
            </span>
          </Link>
