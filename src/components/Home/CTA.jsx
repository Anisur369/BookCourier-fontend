...
const CTA = () => {
  ...
  return (
    <section className="py-16 whitebg text-primary text-center" id="cta">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <p className="text-lg text-secondary max-w-2xl mx-auto mb-6">
          Join BookCourier today and enjoy easy access to your favorite library
          books without ever leaving your home.
        </p>
