...
const Features = () => {
  const features = [
    {
      icon: <FaBook />,
      title: "Browse Books",
      desc: "Explore a variety of books from nearby libraries.",
    },
    {
      icon: <FaHome />,
      title: "Home Delivery",
      desc: "Get books delivered directly to your doorstep.",
    },
    {
      icon: <FaSyncAlt />,
      title: "Schedule Pickups",
      desc: "Arrange convenient times to borrow or return books.",
    },
    {
      icon: <FaClock />,
      title: "Track Status",
      desc: "Keep track of requests, due dates, and returns.",
    },
  ];
  ...
  //   icon: <FaUserCircle />,
  //   title: "User Profiles",
  //   desc: "View profiles for a trusted experience.",
  // },
