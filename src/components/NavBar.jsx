    ...
    <>
      <li>
        <NavLink
          to="/"
          className={({ isActive }) =>
            isActive ? "text-primary font-bold" : "description"
          }
        >
          Home
        </NavLink>
  ...
  return (
    <div className="navbar sticky top-0 z-50 whitebg backdrop-blur-md shadow-sm">
      ...
      <div className="navbar-start">
        ...
        <Link
          to="/"
          className="btn btn-ghost flex items-center gap-2 text-xl text-primary"
        >
        ...
        {user ? (
          <>
            ...
            <div className="dropdown dropdown-end">
              ...
              <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content graybg rounded-box z-50 mt-3 w-64 p-2 shadow-lg"
              >
                ...
                <button
                  ...
                  className="btn btn-error btn-sm mt-1 ml-2 h-8 w-auto text-[15px] px-4 flex items-center gap-2"
                >
                  <FiLogOut /> Logout
                </button>
              </ul>
